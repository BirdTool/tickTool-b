...
createResponder({
    ...
    async run(interaction) {
        ...
        if (interaction.isUserSelectMenu()) {
            ...
            logChannel(interaction, "Staff adicionado", `**Staff adicionado:** ${idList.map(userMention).join(", ")}\n**Cargo:** ${role === "moderator" ? "Moderadores" : role === "admin" ? "Adiministradores" : "Super Administradores"}`, interaction.user.username, interaction.user.displayAvatarURL({ extension: "png" }));
